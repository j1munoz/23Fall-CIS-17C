...
void Game::resetGambler() {
    // Sort the gamblers
    vector<Gambler> temp(gamblers->begin(), gamblers->end());
...
void Game::merge(vector<Gambler>& arr, int left, int middle, int right) {
    int n1 = middle - left + 1;
    int n2 = right - middle;

    vector<Gambler> leftArray(n1);
    vector<Gambler> rightArray(n2);
...
void Game::mergeSort(vector<Gambler>& arr, int left, int right) {
    if (left < right) {
